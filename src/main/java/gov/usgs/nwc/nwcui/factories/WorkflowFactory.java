...
public class WorkflowFactory {
    ...
    private WorkflowFactory() {
    	...
    	workflowMap.put("streamflowstats", new Workflow("streamflowstats", "Streamflow Stats", "/ang/streamflowstats/#/workflow/streamflow-statistics/select-site", "/img/workflow/originals/streamflowStatistics.png"));
