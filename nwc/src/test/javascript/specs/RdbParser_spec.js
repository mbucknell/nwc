describe('RdbParser', function () {
	var firstTableHeaders, secondTableHeaders, firstTableRowCount, secondTableRowCount
	var rdbTables;

	beforeEach(function() {
		firstTableHeaders = ['agency_cd', 'site_no', 'datetime', '02_00060_00003', '02_00060_00003_cd'];
		secondTableHeaders = ['agency_cd', 'site_no', 'datetime', 'blah', 'blah'];
		firstTableRowCount = 5;
		secondTableRowCount = 2;
		...
		rdbTables = NWC.util.RdbParser.parse(rdbSample);
	});
