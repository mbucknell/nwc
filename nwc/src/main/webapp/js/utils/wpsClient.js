...
(function() {
	...
	NWC.util.wps = {};
	NWC.util.wps.defaultResultIdentifier = defaultResultIdentifier;
	NWC.util.wps.defaultStatusIdentifier = defaultStatusIdentifier;
	NWC.util.wps.getDefaultSynchronousResponseForm = function () {
		return {
			'rawDataOutput': {
	...
	NWC.util.wps.getDefaultAsynchronousResponseForm = function(){
		return {
			'responseDocument': {
	...
	NWC.util.wps.getDefaultExecuteAsynchronousRequestParams = function () {
		return{
			status: {
	...
	NWC.util.wps.getProxyUrl = function(url) {
	 ...
	 *
	 */
	NWC.util.wps.getProcessStatusEnum = function(){
		return {
			SUCCEEDED: 1,
			FAILED: 2,
			IN_PROGRESS: 3
