    ...
    <div id="footer" style="width: 100%; margin-right: -1em;">
        ...
        <div class="content" style="padding: 5px;">
            <div id="page-info">
                ...
                <p id="footer-url-info">URL: http://cida.usgs.gov/nwc</p>
                <p id="footer-contact-info">Page Contact Information: <a href="mailto:dblodgett@usgs.gov">dblodgett@usgs.gov</a></p>
