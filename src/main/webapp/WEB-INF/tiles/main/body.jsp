...
<div id="main_page" class="page_body_content">
	<div id="full_dashboard" class="row dashboard navigation_toggle_a">
		<div id="dashboard_nav" class="col-xs-12 col-md-3" style="min-width: 220px; margin-right: -15px;">
		...
		<div id="dashboard_container" class="nwc-container col-xs-12 col-md-9" style="min-width: 220px; margin-left: 15px; padding: 10px; margin-bottom: -10px;">
